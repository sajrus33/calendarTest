        ...
        <div className="popup">
            <form action="#" className="popup__form flexCol">
                ...
                <div className="popup__wrapper--input ">
                    <select onChange={props.handleSelectD} id="day" className="popup__input " required>
                ...
                <div className="flexRow popup__wrapper--time">
                    <div className="popup__wrapper--input ">
                        <select onChange={props.handleSelectH} id="hour" className="popup__input " required>
                            <option className="popup__option" value=""></option>
                    ...
                    <div className="popup__wrapper--input ">
                        <select onChange={props.handleSelectM} id="min" className="popup__input " required>
                            <option className="popup__option" value=""></option>

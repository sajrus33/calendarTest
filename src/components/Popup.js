            ...
            <div className="popup">
                <form action="#" className="popup__form flexCol">
                    <div className="popup__wrapper--message">
                        <textarea ref="txt" onChange={this.props.handleSelects} id="message" placeholder="" className="popup__input popup__input--message" required></textarea>
                        <label htmlFor="message" className="popup__label">Task:</label>
                    </div>
                    <div className="popup__wrapper--input ">
                        <select ref="day" onChange={this.props.handleSelects} id="day" className="popup__input " required>
                    ...
                    <div className="flexRow popup__wrapper--time">
                        ...
                        <div className="popup__wrapper--input ">
                            <select ref="hourS" onChange={this.props.handleSelects} id="hour" className="popup__input " required>
                                <option className="popup__option" value=""></option>
                        ...
                        <div className="popup__wrapper--input ">
                            <select ref="minuteS" onChange={this.props.handleSelects} id="min" className="popup__input " required>
                                <option className="popup__option" value=""></option>
                    ...
                    <div className="flexRow popup__wrapper--time">
                        ...
                        <div className="popup__wrapper--input ">
                            <select ref="hourE" onChange={this.props.handleSelects} id="hour" className="popup__input " required>
                                <option className="popup__option" value=""></option>
                                <option className="popup__option" value="08">08</option>
                                <option className="popup__option" value="09">09</option>
                                <option className="popup__option" value="10">10</option>
                        ...
                        <span className="popup__colon">:</span>
                        <div className="popup__wrapper--input ">
                            <select ref="minuteE" onChange={this.props.handleSelects} id="min" className="popup__input " required>
                                <option className="popup__option" value=""></option>
                                <option className="popup__option" value="00">00</option>
                                <option className="popup__option" value="15">15</option>
                                <option className="popup__option" value="30">30</option>
                    ...
                    <input onClick={this.props.handleSubmit} type="submit" value="Add Task" className="popup__input popup__input--submit"></input>
                </form>
            </div>
        )
    }
